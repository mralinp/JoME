...
import { faLeaf, faPencil, faPlus, faTimes, faCheck } from '@fortawesome/free-solid-svg-icons';
...
const Zones = () => {
    const [zones, setZones] = useState<Zone[]>([
        { id: 1, name: "Zone 1", description: "Front Lawn", active: true, duration: "1:10" },
        { id: 2, name: "Zone 2", description: "Backyard", active: true, duration: "1:20" },
    ]);
                ...
                <div className="zones-list">
                    <Card className="zones-status-card">
                        <div className="zones-header">
                            <h2>Active Zones</h2>
                            <span className="zones-count">{zonesInfo.active}/{zonesInfo.total}</span>
                        </div>
                        <ProgressBar 
                            value={progressValue} 
                            showValue={false}
                                ...
                                <div className="duration-input">
                                    {editingZone.id === zone.id ? (
                                        <InputText 
                                            ...
                                            onChange={(e) => setEditingZone({...editingZone, duration: e.target.value})}
                                            placeholder="HH:MM"
                                        />
                                    ) : (
                                        <input 
